  ...
  return (
    <div className="mx-auto flex min-h-[60dvh] w-full max-w-sm flex-col items-center justify-center gap-8 text-center">
      <div className="flex flex-col gap-2">
        <h1 className="text-[44px] leading-[1.05] font-extrabold tracking-[-0.02em] text-glow">מעקב הזמנה</h1>
        <p className="text-glow-3">הזינו את מספר ההזמנה והאימייל מהרכישה כדי לראות את הסטטוס.</p>
      </div>
