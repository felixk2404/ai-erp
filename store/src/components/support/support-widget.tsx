  ...
  return (
    <>
      <motion.button
        ...
        className="fixed bottom-5 start-5 z-50 grid size-14 place-items-center rounded-full border border-rule bg-panel-2 text-beam transition-colors hover:border-rule-strong hover:bg-panel-3"
      >
        <span
          aria-hidden
        ...
        />
        {/* פעימה אחת כל 8 שניות — "אני כאן", לא לולאת קישוט. */}
        {!reduce && (
          <motion.span
            aria-hidden
