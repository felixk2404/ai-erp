...
NOTES = {
    ...
    '10-order': ('WF10 — הזמנה', 'תת-workflow של WF13, מהחנות או מטופס "הזמנה חדשה" בניהול. מאמת, מתמחר מהקטלוג (לא מהדפדפן), מספר ORD/INV, יוצר לקוח/הזמנה/חשבונית, מוריד מלאי, **רושם את הקונה גם בטבלת הלידים** (Qualified, לא New — כדי שלא יקבל מייל קר), שולח מייל אישור ומודיע לבעלים.', 'Airtable ERP, Gmail ERP, Telegram Manager'),
