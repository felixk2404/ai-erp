...
| תיקייה | מה זה |
|---|---|
| `app/` | אפליקציית הניהול. Next.js 16, אימות בסיסמה, 168 בדיקות. [README](app/README.md) |
| `store/` | החנות ללקוח. Next.js 16, ציבורית, 127 בדיקות. [README](store/README.md) |
...
| WF3 | סוכן מכירות: מייל קר אישי, וקמפיין מוצרים מעוצב ללידים | webhook בלבד, על פי דרישה |
...
4. **הבדיקות** — 295 בדיקות יחידה (`pnpm test` בכל אחת מהאפליקציות, בלי צורך במשתני סביבה) ועוד 34 על צמתי ה-Code של n8n (`cd n8n/code && node --test`).
