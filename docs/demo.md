...
| 6ב | להשיב למייל הקר "מעוניין, כמה עולות 20 יחידות?" (או להריץ את WF4 ידנית) | הליד עובר ל"ענה" ונפתחת משימת "להתקשר ל…". מליד אחר להשיב "הסר" → הליד Dead עם הערה "ביקש הסרה" — הסוכן קורא את התשובה, לא רק סופר אותה | 4:00 |
