...
> **סוכן:** היי! משלוח לחיפה מגיע בדרך כלל תוך 2–4 ימי עסקים. הזמנה שמשולמת עד 14:00 יוצאת עוד באותו יום. מעל 300 ₪ המשלוח חינם. רוצה שאבדוק סטטוס של הזמנה קיימת? אשמח למספר ההזמנה.
