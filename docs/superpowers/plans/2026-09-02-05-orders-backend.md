...
חוקי החנות: כל המחירים כוללים מע"מ 18%. משלוח 29 ₪, חינם בהזמנה מעל 300 ₪, ושירותים (התקנה, תיקון, אבחון) ללא משלוח. אם Stock הוא 0 — אמור שהמוצר אזל והצע חלופה מאותה קטגוריה עם check_stock. אם נותרו פחות מ-5 יחידות — ציין "נותרו X יחידות". שירותים תמיד זמינים. קנייה באתר: הלקוח מוסיף לסל ומסיים בקופה; מעקב הזמנה בעמוד "מעקב" עם מספר ההזמנה והאימייל.
```
