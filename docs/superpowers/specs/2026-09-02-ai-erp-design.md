...
פרויקט גמר/
  ...
  docs/
    ...
    policy.md             מדיניות העסק בעברית (מוזן ל-WF6)
...
תוכן המדיניות ב-`docs/policy.md`: שעות פעילות, משלוחים, החזרות והחלפות, אחריות, תשלומים, מסמכי מס, סטטוסי הזמנה, גבולות לסוכן, טון שיחה. שינוי במדיניות = עריכת הקובץ, הדבקה לצומת ב-WF6, הרצה מחדש.
