...
חוקי מס: מע"מ קבוע 18% (החלטת הסטודנט 2026-09-02: בלי לוגיקת 17% היסטורית), מספור רץ `INV-0001`. מגבלה ידועה: התנגשות מספור אם שתי חשבוניות נוצרות באותה דקה. מקובל.
