...
(function () {
  ...
  window.SCENES["08"] = function (tl, b) {
    ...
    tl.fromTo(s + " .rail .title", { opacity: 0, y: 30 }, { opacity: 1, y: 0, duration: 0.7, ease: "power3.out" }, t(q("easy", 1.5)));
    ...
    const hide = (sel, at) => tl.to(sel, { opacity: 0, duration: 0.35, ease: "power2.in" }, at);
    ...
    C.cam(tl, c5, "Route", 1.4, b.start, 0);
    ...
    C.cam(tl, c5, "Render Menu", 1.4, t(q("buttons", 10.6)) - 0.5, 0.9, "power2.inOut");
    ...
    C.cam(tl, c5, "Create Lead", 1.4, t(q("interested", 11.7)) - 0.3, 0.9, "power2.inOut");
    ...
    show(s + " .p-menu", t(q("buttons", 10.6)) + 0.4, { x: 200, rotationY: 25, transformPerspective: 2200 });
    ...
    show(s + " .p-supabase", t(q("vector", 23.9)), { x: 240, rotationY: -25, transformPerspective: 2200 });
    ...
    C.cam(tl, ch, "Create Task", 1.5, t(q("hands", 33.4)) - 0.4, 0.9, "power2.inOut");
    ...
    show(s + " .p-handoff", t(q("hands", 33.4)) + 0.6, { x: 200, rotationY: 25, transformPerspective: 2200 });
